...
class BloomAttention(nn.Module):
    ...
    def attn_score(self,
        ...
        return input_dtype, batch_size, q_length, kv_length, value_layer, present, attn_weights
    ...
    def forward(
        ...
        if self.pnlq_config is not None and 'awsm_quantization' in self.pnlq_config:
            ...
            _, _, _, _, _, _, quantized_weights = self.attn_score(quantized_hidden_states, quantized_alibi, attention_mask, quantized_layer_past, use_cache)
        else:
            quantized_weights = None

        attention_probs = self.softmax(attn_weights, quantized_weights).to(input_dtype)
